...
* The idea of the internet started in the **Cold War era**.
* Computers at that time were **big machines** and worked in isolation.
* Scientists thought: “What if computers could communicate and share information with each other?”
...
* In the 1970s, scientists developed rules for communication called **protocols**.
* The most important was **TCP/IP** (Transmission Control Protocol / Internet Protocol) created by **Vint Cerf and Bob Kahn**.
...
* In **1983**, ARPANET officially switched to **TCP/IP**, making it the technical foundation of today’s internet.
* The word **“Internet”** started being used.
...
* In **1989**, **Tim Berners-Lee** at CERN (Switzerland) invented the **World Wide Web (WWW)**.
* He developed:
...
* In **1993**, the first popular web browser **Mosaic** was released, later becoming **Netscape Navigator**.
* Companies realized the internet could be used for **business, communication, and entertainment**.
* **E-commerce** began → Amazon (1994), eBay (1995).
...
* In the 2000s, internet speed improved with **broadband connections** (faster than dial-up).
...
* With smartphones (iPhone in 2007, Android in 2008), the internet became **mobile-first**.
* Apps, social media, and mobile browsing became the norm.
* **Cloud computing** (Google Drive, Dropbox, AWS) allowed storing and sharing files online.
...
* **5G networks** are making internet faster and more connected.
* **AI (Artificial Intelligence)** and **IoT (Internet of Things)** are now part of the internet.
...
1. 1960s → Concept of networking (J.C.R. Licklider).
2. 1969 → ARPANET sends first message.
3. 1970s → TCP/IP + Email invented.
4. 1980s → Internet expansion + DNS created.
5. 1990s → World Wide Web invented (Tim Berners-Lee).
6. 1990s → E-commerce & search engines rise.
7. 2000s → Social media + broadband + Web 2.0.
8. 2010s → Smartphones, apps, cloud, streaming.
9. 2020s → AI, IoT, 5G, global connectivity.